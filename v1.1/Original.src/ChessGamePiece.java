...
public abstract class ChessGamePiece{
    ...
    */
    ...
    public interface MoveStrategy {
        ArrayList<String> calculateMoves(ChessGameBoard board, int numMoves);
    }
    
    public class NorthMoveStrategy implements MoveStrategy {
        @Override
        public ArrayList<String> calculateMoves(ChessGameBoard board, int numMoves) {
            ArrayList<String> moves = new ArrayList<String>();
            int count = 0;
            if (isPieceOnScreen()) {
